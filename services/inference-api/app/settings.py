...
from lychee_common.device import _torch_cuda_runtime as _shared_torch_cuda_runtime
from lychee_common.device import resolve_torch_device as _shared_resolve_torch_device
...
def _torch_cuda_runtime() -> tuple[bool, int]:
    return _shared_torch_cuda_runtime()


def resolve_torch_device(device: str) -> tuple[str, str | None]:
    return _shared_resolve_torch_device(device, cuda_runtime=_torch_cuda_runtime)
